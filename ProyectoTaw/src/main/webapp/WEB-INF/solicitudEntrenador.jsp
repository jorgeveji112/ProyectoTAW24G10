    ...
    <div class="contenido">
        <table>
            ...
            <tr>
                <th></th>
                <th></th>
                <th><button class="boton" onclick="window.location='/adminMain/solicitud/aceptar/<%=usuario.getId()%>'">Aceptar</button></th>
                <th><button class="boton" onclick="window.location='/adminMain/solicitud/rechazar/<%=usuario.getId()%>'">Rechazar</button></th>
            </tr>
        </table>
    </div>
</div>
